...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        // Shadow hierarchy: subtle < game < game-md < game-lg
        'subtle': '0 1px 3px 0 rgba(0, 0, 0, 0.05)',
        'game': '0 4px 14px 0 rgba(0, 0, 0, 0.1)',
        'game-md': '0 6px 20px -2px rgba(0, 0, 0, 0.12)',
        'game-lg': '0 10px 25px -3px rgba(0, 0, 0, 0.15)',
        'game-xl': '0 20px 40px -5px rgba(0, 0, 0, 0.2)',
